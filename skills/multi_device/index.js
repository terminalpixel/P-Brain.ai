...
class MultiDeviceSkill extends PBrainSkill {
    constructor() {
        super('multi_device');
    }

    examples() {
        return ['Call this device my laptop.', 'Call this device the TV.', 'On my TV play Game Of Thrones', 'On the laptop tell me the time.']
    }
    ...
    * get(query, breakdown, user, token) {
...
module.exports = MultiDeviceSkill;
